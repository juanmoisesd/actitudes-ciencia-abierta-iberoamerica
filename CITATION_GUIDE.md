...
### APA 7ª Edición
```
de la Serna Tuya, J. M. (2026). Actitudes hacia la Ciencia Abierta e Iberoamérica: Dataset Global. GitHub. https://github.com/juanmoisesd/actitudes-ciencia-abierta-iberoamerica
```

### Chicago Autor-Fecha
```
de la Serna Tuya, Juan Moisés. 2026. "Actitudes hacia la Ciencia Abierta e Iberoamérica: Dataset Global." GitHub. https://github.com/juanmoisesd/actitudes-ciencia-abierta-iberoamerica.
```

### BibTeX
```bibtex
@misc{delaserna2026_actitudescie,
  author       = {de la Serna Tuya, Juan Moisés},
  title        = {Actitudes hacia la Ciencia Abierta e Iberoamérica: Dataset Global},
  year         = {2026},
...
TI  - Actitudes hacia la Ciencia Abierta e Iberoamérica: Dataset Global
PY  - 2026
PB  - GitHub
UR  - https://github.com/juanmoisesd/actitudes-ciencia-abierta-iberoamerica
...
### Vancouver / IEEE
```
de la Serna Tuya JM. Actitudes hacia la Ciencia Abierta e Iberoamérica: Dataset Global. GitHub; 2026. Available: https://github.com/juanmoisesd/actitudes-ciencia-abierta-iberoamerica. ORCID: 0000-0002-8401-8018.
```
